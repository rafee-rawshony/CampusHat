...
export function SellerSidebarContent() {
    ...
    const NAV_ITEMS = [
        { label: 'Overview',    href: '/dashboard/seller',             icon: LayoutDashboard, exact: true },
        { label: 'Products',    href: '/dashboard/seller/products',    icon: Package, exact: true,
            badge: statsData?.out_of_stock_products > 0 ? statsData.out_of_stock_products : null },
        { label: 'Bulk Upload', href: '/dashboard/seller/products/bulk-upload', icon: Upload },
        { label: 'Top Products', href: '/dashboard/seller/products/top', icon: TrendingUp },
        ...
        { label: 'Returns',     href: '/dashboard/seller/returns',     icon: RotateCcw },
        { label: 'Reviews',     href: '/dashboard/seller/reviews',     icon: Star },
        { label: 'Customers',   href: '/dashboard/seller/customers',   icon: Users },
        { label: 'Performance', href: '/dashboard/seller/performance', icon: BarChart3 },
        { label: 'Coupons',     href: '/dashboard/seller/promotions/coupons',     icon: Tag },
        { label: 'Flash Sales', href: '/dashboard/seller/promotions/flash-sales', icon: Zap },
        { label: 'Wallet',      href: '/dashboard/seller/wallet',      icon: Wallet },
        { label: 'Messages',    href: '/dashboard/seller/messages',    icon: MessageCircle },
