...
export default function MyAdsPage() {
    ...
    return (
        <div className="bg-white min-h-screen pb-20 pt-4 sm:pt-8">
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                {isLoading ? (
                    ...
                    /* Global Empty State */
                    <div className="flex flex-col items-center justify-center bg-white border border-gray-200 rounded-2xl py-10 sm:py-16 px-4 sm:px-6 text-center shadow-sm">
